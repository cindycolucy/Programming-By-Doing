public class FunctionCallAlphabet {
    ...
    // Function Call Alphabet - Yet another program to practice functions, but this time it's function calls only.
        ...
        public static void main( String[] args )
        {
            ...
            i(9);    // pass it any integer and it will display a word beginning with I
            System.out.println(j(2));;    // returns a different word depending on what you pass it (1-3)
            ...
            n("Nectarine");    // displays the word you pass it beginning with "N"
            ...
            t("Turd");    // displays the word you pass it beginning with "T"
            ...
            System.out.println(z(true, false));;    // returns a different word depending on which two boolean values you pass it
            System.out.println();
        }
